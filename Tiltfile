...
kubewarden_yaml = helm(
    ...
    set=[
        ...
        "recommendedPolicies.defaultPoliciesRegistry=" + registry,
    ],
)
...
# Object name comes from the fullname helper: <release>-<chart> = kubewarden-adm-controller.
